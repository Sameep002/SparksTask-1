...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg  fixed fixed-top"
        style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px black;  background-color: #3C79F5; color:white;">
            ...
            <b>
                <ul class="navbar-nav ">
                    <li class="nav-item nav-links" style="margin-left:15px;">
                        <a class="nav-link active text-nowrap" style="color:white;" aria-current="page" href="index.php">Home</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px; ">
                        <a class="nav-link text-nowrap" style="color:white;" href="send_money.php">Send Money</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" style="color:white;" href="all_cust.php">View All Customers</a>
                    </li>
    ...
    <div class="container-large"
        style="color:white; height:100vh; width: 100%; padding:8% 2% 2% 2%; ">
        <div class="row">
            <div class="col" style="margin-left: 5%; margin-top:15%">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Sparks Bank!</b></p>
                <p class=""
                    style="font-size:2rem; text-shadow:3px 3px 3px grey; text-align:center;"><b>One place to send money to other users</b></p>
            </div>
    ...
    <center style="background-color:#212529;">
        <div class="container"
            style="backdrop-filter: blur(10px); box-shadow:3px 3px 15px black; border-radius:30px; padding:20px 0px 20px 0px;">
            <h1 style="text-shadow:2px 2px 2px gray; color:#89C4E1;"><b>Our Awesome Facilities</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#89C4E1; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
